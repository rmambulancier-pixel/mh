...
check('Release target',version=='30.0.0' and code=='3000')
...
check('Backup namespace',"BACKUP_VERSION='30.0.0'" in backup and "LS+'_v30_backup_'" in backup and "LS+'_v28_backup_'" in backup)
