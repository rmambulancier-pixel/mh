const CACHE = 'mesheures-shell-v24.2.0';
const SHELL = [
  './',
  './index.html',
  './manifest.json',
  './icon.svg',
  './icon-512.png',
  './style/refonte.css?v=24.2.0',
  './style/v24-modules.css?v=24.2.0',
  './style/v24.css?v=24.2.0',
  './scripts/app-core.js',
  './scripts/app-pwa.js',
  './scripts/app-ui.js',
  ...
  './scripts/app-v24.js',
  './scripts/app-v24-analysis.js',
  './scripts/app-v24-features.js',
