...
(function () {
  ...
  function syncVersion() {
    document.title = document.title.replace(/V16\.1(?:\.0)?|V16\.2(?:\.0)?|V17(?:\.0\.1)?/g, 'V30.2.2');
    ...
    nodes.forEach(n => {
      if (/V16\.1\.0|V16\.2\.0/.test(n.nodeValue || '')) {
        n.nodeValue = n.nodeValue
          .replace(/V16\.1\.0/g,'V30.2.2')
          .replace(/V16\.2\.0/g,'V30.2.2');
      }
    });
  }
...
/* V30.2.2 — le résumé de paie canonique est exposé par app-core.js.
