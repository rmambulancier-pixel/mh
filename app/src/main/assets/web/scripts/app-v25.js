...
(function(){
  ...
  function boot(){
    // V30 owns navigation and rendering orchestration. V25 remains the canonical
    // day/live renderer used by the V30 scheduler.
    window.renderHome=renderHome25;
    window.renderDay=renderDay25;
    buildAnalysis();
    buildNav25();
    if(el('mhVersion'))el('mhVersion').textContent='V30.0.1';
  }
