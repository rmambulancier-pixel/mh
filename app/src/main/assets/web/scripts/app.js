...
function renderPay(){
  ...
  // V24.0.0 : le champ « Écart bulletin » ne doit plus confondre
...
function mhAutoBackup(){
  /* V23: normal save() is the persistence layer; snapshot backups are explicit from Outils > Données. */
}
...
if($('mhVersion'))$('mhVersion').textContent='V24.0.0';
mhDecoratePages();
mhAutoBackup();
