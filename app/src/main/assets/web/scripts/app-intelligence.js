/* MesHeures V24.2.0 — intelligence locale : intelligence locale, patterns, projection 12 semaines, alertes */
(function(){
  const V='24.2.0';
  ...
  // V30 owns the Intelligence DOM. This module is data-only so it cannot
  // inject a second card or wrap the reactive renderer.
  function injectLegacy(){ return false; }

  function boot(){
    // Intentionally no automatic DOM injection. app-v28.js renders the single
    // canonical Intelligence card (#mh28Intel).
  }
