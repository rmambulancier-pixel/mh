...
(function(){
  ...
  function buildNav(){
    ...
    if(!$('mhV24Dots')){const d=document.createElement('div');d.id='mhV24Dots';d.className='mh-v24m-nav-state';PAGES.forEach(()=>d.appendChild(document.createElement('i')));document.body.appendChild(d)}
    setNav();
  }
  function patchTouch(){
    if(window.__mhV24Touch)return;window.__mhV24Touch=true;
