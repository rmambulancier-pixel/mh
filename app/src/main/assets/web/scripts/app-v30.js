/* MesHeures V30.2.4 — canonical runtime
...
(function(){
  ...
  function renderHome(){
    /* V30.2.4: Smart Control owns Accueil.
  ...
  function boot(){
    ...
    if($('mhVersion'))$('mhVersion').textContent='V30.2.4';
    document.title='MesHeures V30.2.4';
    patchSave();
    ...
    /* V30.2.4: tactile retour de secours */
