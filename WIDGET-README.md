# MesHeures V18.0.18 — Widget Android

Widget natif ajouté au socle V18.0.18. Il affiche uniquement un cache JSON produit par le WebView.

## V18.0.18 — Widget V3 : source de vérité paie
