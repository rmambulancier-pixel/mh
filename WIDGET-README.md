# MesHeures V18.0.22 — Widget Android

Widget natif ajouté au socle V18.0.22. Il affiche uniquement un cache JSON produit par le WebView.

## V18.0.22 — Widget V3 : source de vérité paie
...
## V18.0.22 — Widget V7
- Ajout d'une zone basse utile : solde RC et prochaine journée planifiée.
- Le solde RC privilégie le dernier relevé ROMI disponible ; à défaut, il est dérivé du moteur MesHeures pour la période active.
- La prochaine journée est recherchée dans les données de planning futures, sans inventer de journée absente.
- Horaires affichés lorsqu'ils sont disponibles.
- Le moteur de calcul reste côté WebView ; Android ne fait que présenter le payload.
