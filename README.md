# MesHeures V18.0.20 — Android + PWA

> **Version actuelle : V18.0.20 — Android versionCode 1820**

## V18.0.20 — Widget Android V3 intégré

Cette version part du socle V18.0.20 audité et ajoute le widget Android sans réintroduire les anciennes couches/fichiers fantômes.
...
- Version runtime synchronisée en `18.0.19` / `versionCode 1820`.
