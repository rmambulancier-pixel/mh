# MesHeures V18.0.21 — Android + PWA

> **Version actuelle : V18.0.21 — Android versionCode 1821**

## V18.0.21 — Widget Android V3 intégré

Cette version part du socle V18.0.21 audité et ajoute le widget Android sans réintroduire les anciennes couches/fichiers fantômes.
...
- Version runtime synchronisée en `18.0.21` / `versionCode 1821`.
